  ...
  return (
    <>
      ...
      <Typography className={classes.section}>
        ...
        It's got thermal and mechanical properties, is biodegradable, FDA approved, and its{' '}
        <em>super</em> absorbent. But if we’re being realistic, we know that the science behind
        isn’t just comparing these things in their pure state. It’s pretty likely that whatever is
        selected, whether it be something we talked about today or not, will be some sort of hybrid;
        multiple elements will be combined into one to make the most optimal food packaging
        alternative.
      </Typography>
      <Typography className={classes.section}>
